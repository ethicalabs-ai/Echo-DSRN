...
# ─────────────────────────────────────────────────────────────────────────────
# Qwen3 variants — same architecture, different base model classes
# ─────────────────────────────────────────────────────────────────────────────


class Qwen3HybridEchoModel(Qwen3PreTrainedModel):
    config_class = Qwen3HybridEchoConfig
    _tp_plan = {}

    def __init__(self, config: Qwen3HybridEchoConfig):
        super().__init__(config)
...
class Qwen3HybridEchoForCausalLM(Qwen3PreTrainedModel, GenerationMixin):
    config_class = Qwen3HybridEchoConfig
    _tp_plan = {}
    _is_causal = True
    supports_gradient_checkpointing = True
    ...
    def __init__(self, config: Qwen3HybridEchoConfig):
        super().__init__(config)
        self.model = Qwen3HybridEchoModel(config)
        self.vocab_size = config.vocab_size
        self.lm_head = nn.Linear(config.hidden_size, config.vocab_size, bias=False)
        self.post_init()
